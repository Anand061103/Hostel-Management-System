...
@section('content')
    ...
    <div class="p-6">
        ...
        @if (session('success'))
            <div
                class="mb-4 rounded-lg border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-700 dark:border-emerald-900 dark:bg-emerald-900/20 dark:text-emerald-400">
                {{ session('success') }}
            </div>
        @endif
        ...
        @if (session('error'))
            <div
                class="mb-4 rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700 dark:border-red-900 dark:bg-red-900/20 dark:text-red-400">
                {{ session('error') }}
            </div>
        @endif
                            ...
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div
                                            class="flex h-10 w-10 items-center justify-center rounded-full bg-blue-100 font-semibold text-blue-600 dark:bg-blue-900/30 dark:text-blue-400">
                                ...
                                <td class="px-6 py-4 text-right">
                                    ...
                                    {{-- check out --}}
                                    @if ($student->status === 'active')
                                        <a href="{{ route('students.checkout.create', $student) }}"
                                            class="px-3 py-1 text-sm rounded-lg bg-orange-500 text-white hover:bg-orange-600">
                                            Checkout
                                        </a>
                                    @endif
